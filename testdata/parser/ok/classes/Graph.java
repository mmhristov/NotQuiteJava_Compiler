...
class Node {
	...
	boolean beq(boolean a, boolean b) { // shadowing a
		return (!(!(a && b) && !(!a && !b)));
	}

	boolean dfs(boolean vis, Label b) {
		boolean result;
