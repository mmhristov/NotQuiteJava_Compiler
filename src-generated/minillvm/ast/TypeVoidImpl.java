...
class TypeVoidImpl implements TypeVoid{
    TypeVoidImpl() {
    }
    ...
    @Override public TypeVoid copy() {
        TypeVoid result = new TypeVoidImpl();
        return result;
    }

    @Override public TypeVoid copyWithRefs() {
        TypeVoid res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Type.Matcher<T> matcher) {
        return matcher.case_TypeVoid(this);
    }
    @Override public void match(Type.MatcherVoid matcher) {
        matcher.case_TypeVoid(this);
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((TypeVoid)this);
    }
    /** "checks, whether this type is equal to another type"*/
    public boolean equalsType(Type other) {
        return minillvm.analysis.Typechecker.equalsType((TypeVoid)this, other);
    }
}
