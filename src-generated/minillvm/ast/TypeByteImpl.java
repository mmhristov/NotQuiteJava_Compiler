...
class TypeByteImpl implements TypeByte{
    TypeByteImpl() {
    }
    ...
    @Override public TypeByte copy() {
        TypeByte result = new TypeByteImpl();
        return result;
    }

    @Override public TypeByte copyWithRefs() {
        TypeByte res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Type.Matcher<T> matcher) {
        return matcher.case_TypeByte(this);
    }
    @Override public void match(Type.MatcherVoid matcher) {
        matcher.case_TypeByte(this);
    }
    ...
    public boolean structuralEquals(Element e) {
        return e instanceof TypeByte;
    }
    /** */
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((TypeByte)this);
    }
    /** "checks, whether this type is equal to another type"*/
    public boolean equalsType(Type other) {
        return minillvm.analysis.Typechecker.equalsType((TypeByte)this, other);
    }
}
