...
class TypeBoolImpl implements TypeBool{
    TypeBoolImpl() {
    }
    ...
    @Override public TypeBool copy() {
        TypeBool result = new TypeBoolImpl();
        return result;
    }

    @Override public TypeBool copyWithRefs() {
        TypeBool res = copy();
        return res;
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((TypeBool)this);
    }
    /** "checks, whether this type is equal to another type"*/
    public boolean equalsType(Type other) {
        return minillvm.analysis.Typechecker.equalsType((TypeBool)this, other);
    }
}
