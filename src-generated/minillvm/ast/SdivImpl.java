...
class SdivImpl implements Sdiv{
    SdivImpl() {
    }
    ...
    @Override public Sdiv copy() {
        Sdiv result = new SdivImpl();
        return result;
    }

    @Override public Sdiv copyWithRefs() {
        Sdiv res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Operator.Matcher<T> matcher) {
        return matcher.case_Sdiv(this);
    }
    @Override public void match(Operator.MatcherVoid matcher) {
        matcher.case_Sdiv(this);
    }
    ...
    public boolean structuralEquals(Element e) {
        return e instanceof Sdiv;
    }
    /** */
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((Sdiv)this);
    }
}
