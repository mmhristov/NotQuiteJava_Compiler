...
class ParameterListImpl extends ParameterList {
    ...
    protected void other_setParentToThis(Parameter t) {
        t.setParent(this);
    }

    protected void other_clearParent(Parameter t) {
        t.setParent(null);
    }

    @Override
    public Element set(int i, Element newElement) {
        return ((AsgList<Parameter>) this).set(i, (Parameter) newElement);
    }

    @Override public <T> T match(Element.Matcher<T> matcher) {
        return matcher.case_ParameterList(this);
    }
    @Override public void match(Element.MatcherVoid matcher) {
        matcher.case_ParameterList(this);
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((ParameterList)this);
    }
}
