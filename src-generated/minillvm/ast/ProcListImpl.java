...
class ProcListImpl extends ProcList {
    ...
    protected void other_setParentToThis(Proc t) {
        t.setParent(this);
    }

    protected void other_clearParent(Proc t) {
        t.setParent(null);
    }

    @Override
    public Element set(int i, Element newElement) {
        return ((AsgList<Proc>) this).set(i, (Proc) newElement);
    }

    @Override public <T> T match(Element.Matcher<T> matcher) {
        return matcher.case_ProcList(this);
    }
    @Override public void match(Element.MatcherVoid matcher) {
        matcher.case_ProcList(this);
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((ProcList)this);
    }
}
