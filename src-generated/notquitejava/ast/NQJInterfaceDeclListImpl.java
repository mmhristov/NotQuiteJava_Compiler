...
class NQJInterfaceDeclListImpl extends NQJInterfaceDeclList {
    ...
    protected void other_setParentToThis(NQJInterfaceDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJInterfaceDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJInterfaceDecl>) this).set(i, (NQJInterfaceDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_InterfaceDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_InterfaceDeclList(this);
    }
    ...
    @Override public void clearAttributes() {
        for (NQJInterfaceDecl child : this) {
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("InterfaceDeclList(");
        boolean first = true;
        for (NQJInterfaceDecl i : this ) {
