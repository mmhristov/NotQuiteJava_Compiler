...
class NQJFunctionDeclListImpl extends NQJFunctionDeclList {
    ...
    protected void other_setParentToThis(NQJFunctionDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJFunctionDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJFunctionDecl>) this).set(i, (NQJFunctionDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_FunctionDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_FunctionDeclList(this);
    }
    ...
    @Override public void clearAttributes() {
        for (NQJFunctionDecl child : this) {
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("FunctionDeclList(");
        boolean first = true;
        for (NQJFunctionDecl i : this ) {
