...
class NQJClassDeclListImpl extends NQJClassDeclList {
    ...
    protected void other_setParentToThis(NQJClassDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJClassDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJClassDecl>) this).set(i, (NQJClassDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_ClassDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_ClassDeclList(this);
    }
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("ClassDeclList(");
        boolean first = true;
        for (NQJClassDecl i : this ) {
