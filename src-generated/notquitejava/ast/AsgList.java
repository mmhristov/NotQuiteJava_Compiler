...
abstract class AsgList<T> implements List<T> {
 ...
 @SuppressWarnings("unchecked")
	...
	public boolean structuralEquals(NQJElement e) {
		if (e instanceof AsgList) {
			...
			for (int i=0; i<size(); i++) {
				NQJElement a = (NQJElement) get(i);
				NQJElement b = (NQJElement) o.get(i);
	...
	@SuppressWarnings({"unchecked", "rawtypes"})	public void forEachElement(java.util.function.Consumer<? super NQJElement> action) {
