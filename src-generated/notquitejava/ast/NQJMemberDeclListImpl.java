...
class NQJMemberDeclListImpl extends NQJMemberDeclList {
    ...
    protected void other_setParentToThis(NQJMemberDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJMemberDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJMemberDecl>) this).set(i, (NQJMemberDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_MemberDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_MemberDeclList(this);
    }
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("MemberDeclList(");
        boolean first = true;
        for (NQJMemberDecl i : this ) {
