...
class NQJVarDeclListImpl extends NQJVarDeclList {
    ...
    protected void other_setParentToThis(NQJVarDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJVarDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJVarDecl>) this).set(i, (NQJVarDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_VarDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_VarDeclList(this);
    }
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("VarDeclList(");
        boolean first = true;
        for (NQJVarDecl i : this ) {
