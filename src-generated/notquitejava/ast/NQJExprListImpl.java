...
class NQJExprListImpl extends NQJExprList {
    ...
    protected void other_setParentToThis(NQJExpr t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJExpr t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJExpr>) this).set(i, (NQJExpr) newElement);
    }
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("ExprList(");
        boolean first = true;
        for (NQJExpr i : this ) {
