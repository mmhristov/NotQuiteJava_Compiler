...
class NQJUnaryMinusImpl implements NQJUnaryMinus{
    NQJUnaryMinusImpl() {
    }
    ...
    @Override public NQJUnaryMinus copy() {
        NQJUnaryMinus result = new NQJUnaryMinusImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJUnaryMinus copyWithRefs() {
        NQJUnaryMinus res = copy();
        return res;
    }
    ...
    @Override public <T> T match(NQJUnaryOperator.Matcher<T> matcher) {
        return matcher.case_UnaryMinus(this);
    }
    @Override public void match(NQJUnaryOperator.MatcherVoid matcher) {
        matcher.case_UnaryMinus(this);
    }
    ...
    public boolean structuralEquals(NQJElement e) {
        return e instanceof NQJUnaryMinus;
    }
